...
let create_person n = let (nom, anniiv, adress) = n in
        {name = (fst nom, snd nom); anniv = anniiv; address = adress};;
...
let compare_address a1 a2 = 
        a1.numero = a2.numero && a1.voie = a2.voie && a1.nom = a2.nom;;
